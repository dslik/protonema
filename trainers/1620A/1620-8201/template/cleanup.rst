...
This cleanup process takes five minutes.
    ...
    * - 7.2.3
      ...
      - 
        .. raw:: latex
          ...
          \includegraphics[align=t,scale=1]{../../images/doc_stamp.pdf}
    * - 7.2.4
      - Return the springback binder with the newly printed document to the :math:`\constprojnumfull` section of the store supply shelf.
      - 
        .. raw:: latex
