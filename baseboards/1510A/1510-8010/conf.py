...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-12-21 }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1510}
    \newcommand{\constProdNumRaw}{1510A}
    \newcommand{\constProdNameUpperRaw}{Protonema Baseboard}
    \newcommand{\constProdNameLowerRaw}{Protonema baseboard}
