...
latex_maketitle = r'''
    \begin{titlepage}
        \begingroup % for PDF information dictionary
           ...
           \hypersetup{pdfauthor={David Slik}, pdftitle={1510A Assembly}}%
        \endgroup
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large 1510A Protonema Baseboard }\par
            \vspace{20pt}
            \sphinxlogo
            \vspace{20pt}
            {\Large Document control number: 1510-8010 }\par
            \vspace{10pt}
            {\Large Document date: 2022-10-27 }\par
            \vspace{10pt}
        ...
        \begin{flushleft}
            {\normalsize
                ABSTRACT: This document provides instructions on how to assembly and test a 1510A Protonema baseboard. A complete bill of materials is included as an annex. 
            }\par
            {\normalsize
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily 1510-8010 - 1510A assembly instructions v\version}}
...
latex_documents = [
    (master_doc, '1510-8010.tex', '1510A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1510A.jpg'
