...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-12-23 }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1522}
    \newcommand{\constProdNumRaw}{1522A}
    \newcommand{\constProdNameUpperRaw}{Protonema 2x2 Baseboard}
    \newcommand{\constProdNameLowerRaw}{Protonema 2x2 baseboard}
...
latex_documents = [
    (master_doc, '1522-8010.tex', '1522A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1522A.jpg'
