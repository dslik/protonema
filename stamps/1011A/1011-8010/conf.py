...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-10-10 }\par
            \vspace{10pt}
            {\Large Document revision: v1.0 }\par
            \vspace{20pt}
        \end{center}
        \begin{flushleft}
            {\normalsize
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1011}
    \newcommand{\constProdNumRaw}{1011A}
    \newcommand{\constProdNameUpperRaw}{Horizontal Breadboard Stamp}
    \newcommand{\constProdNameLowerRaw}{horizontal breadboard stamp}
...
latex_documents = [
    (master_doc, '1011-8010.tex', '1011A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1011A.jpg'
