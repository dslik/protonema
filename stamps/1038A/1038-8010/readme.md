# 1038A Assembly Manual

This repository contains the source files used to build document number 1038-8010, the 1038A Assembly manual.
...
15. From the Mac Terminal, in the 1038A-main directory, cd into the docs/assembly directory
16. Run `make latexpdf` to build the document
17. Run `open _build/latex/1038-8010.pdf` to open the newly built PDF
