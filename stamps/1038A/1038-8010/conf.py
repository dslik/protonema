...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-11-26 }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1038}
    \newcommand{\constProdNumRaw}{1038A}
    \newcommand{\constProdNameUpperRaw}{LED Display Stamp}
    \newcommand{\constProdNameLowerRaw}{LED display stamp}
...
latex_documents = [
    (master_doc, '1038-8010.tex', '1038A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1038A.jpg'
