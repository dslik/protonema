...
latex_maketitle = r'''
    \begin{titlepage}
        \begingroup % for PDF information dictionary
           ...
           \hypersetup{pdfauthor={David Slik}, pdftitle={1031A Assembly}}%
        \endgroup
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large 1031A Raspberry Pi Pico Stamp }\par
            \vspace{20pt}
            \sphinxlogo
            \vspace{20pt}
            {\Large Document control number: 1031-8010 }\par
            \vspace{10pt}
            {\Large Document date: 2022-08-28 }\par
            \vspace{10pt}
            {\Large Document revision: v0.3 }\par
            \vspace{20pt}
        \end{center}
        \begin{flushleft}
            {\normalsize
                ABSTRACT: This document provides instructions on how to assembly and test a 1031A Raspberry Pi Pico stamp. A complete bill of materials is included as an annex. 
            }\par
            {\normalsize
               Suggestions and corrections should be directed to http://www.github.com/dslik/protonema/issues
            }\par
            {\large
...
latex_elements = {
    ...
    \fancypagestyle{normal}{
        \fancyhf{}
        \fancyhead[LE,LO]{{\py@HeaderFamily 1031-8010 - 1031A assembly instructions v\version}}
...
latex_documents = [
    (master_doc, '1031-8010.tex', '1031A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1031A.jpg'
