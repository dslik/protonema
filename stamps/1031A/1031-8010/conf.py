...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-12-10 }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1031}
    \newcommand{\constProdNumRaw}{1031A}
    \newcommand{\constProdNameUpperRaw}{Raspberry Pi Pico Stamp}
    \newcommand{\constProdNameLowerRaw}{Raspberry Pi Pico stamp}
