...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2023-01-07 }\par
            \vspace{10pt}
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1060}
    \newcommand{\constProdNumRaw}{1060A}
    \newcommand{\constProdNameUpperRaw}{Dual Potentiometer Stamp}
    \newcommand{\constProdNameLowerRaw}{dual potentiometer stamp}
    ...
    \fancypagestyle{normal}{
        ...
        \fancyfoot[LE,LO]{{\py@HeaderFamily \copyright \  VE7FIM 2023}}
...
latex_documents = [
    (master_doc, '1060-8010.tex', '1060A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1060A.jpg'
