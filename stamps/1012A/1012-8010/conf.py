...
latex_maketitle = r'''
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \vspace{10pt}
            {\Large Document date: 2022-11-22 }\par
            \vspace{10pt}
            {\Large Document revision: v1.0.0-draft.2 }\par
            \vspace{20pt}
        \end{center}
        \begin{flushleft}
            {\normalsize
...
latex_elements = {
    ...
    % Variables
    \newcommand{\constPartNumRaw}{1012}
    \newcommand{\constProdNumRaw}{1012A}
    \newcommand{\constProdNameUpperRaw}{Vertical Breadboard Stamp}
    \newcommand{\constProdNameLowerRaw}{vertical breadboard stamp}
...
latex_documents = [
    (master_doc, '1012-8010.tex', '1012A assembly instructions',
     'DRAFT', 'manual'),
]

latex_logo = 'images/1012A.jpg'
